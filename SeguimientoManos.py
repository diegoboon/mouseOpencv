...
class detectormanos():
    def __init__(self, mode=False, modelComplexity=10, maxManos = 2, Confdeteccion = 0.5, Confsegui = 0.5):
        self.mode = mode
        ...
        self.manos = self.mpmanos.Hands(self.mode, self.modelComplex, self.maxManos, self.Confdeteccion, self.Confsegui)
    ...
    def encontrarposicion(self,frame, ManoNum = 0, dibujar = True):
        ...
        if self.resultados.multi_hand_landmarks:
            ...
            for id, lm in enumerate(miMano.landmark):
                ...
                if dibujar:
                    cv2.circle(frame,(cx,cy), 5, (38,151,0), cv2.FILLED)
